...
def generate_pde_data(key):
    ...
    pts = lhs(2, samples=n_sample, criterion="maximin")
    xlo, xhi = DOMAIN_X
    ylo, yhi = DOMAIN_Y
...
def run_siren():
    ...
    siren_W_x = _sample_frequencies(k_wx, FF_DIM).reshape(1, -1)
    siren_W_y = _sample_frequencies(k_wy, FF_DIM).reshape(1, -1)
    ff_input_dim_siren = 4 * FF_DIM
    LAYERS = [ff_input_dim_siren, 128, 128, 128, 128, 3]
