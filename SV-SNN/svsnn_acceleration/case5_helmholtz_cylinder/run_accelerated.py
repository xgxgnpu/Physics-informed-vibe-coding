...
def run_svsnn_accelerated(data):
    ...
    def init_params(key):
        ...
        for n in range(NUM_MODES):
            freqs_x = _sample_frequencies(keys[ki], NUM_FREQ, KAPPA); ki += 1
            ...
            freqs_y = _sample_frequencies(keys[ki], NUM_FREQ, KAPPA); ki += 1
...
def init_siren(key, ff_dim=64):
    ...
    ff_input = 4 * ff_dim
    layers_list = [ff_input, 128, 128, 128, 128, 1]
...
def train_spinn(data, epochs=EPOCHS):
